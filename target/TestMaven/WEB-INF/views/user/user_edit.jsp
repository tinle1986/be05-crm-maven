...
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="col-md-8 col-xs-12">
			<div class="white-box">
				<form method="post" action="<%=contextPath%>/user/edit?id=${user.id}" class="form-horizontal form-material">
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<input type="number" placeholder="Role ID"
										 class="form-control form-control-line" name="roleId" value="${user.roleId}"></div>
					</div>
					<div class="form-group">
						<div class="col-sm-12">
